...
export const apis = [
  ...
  {
    name: '获取文章列表',
    description: '使用短期 Credential 获取公众号历史文章列表。',
    ...
    params: [
      ...
      },
      {
        ...
        default: 'N/A',
        type: 'String',
        remark: '从 Charles 会话请求头导入的短期 Credential',
      },
      {
        label: '微信 Key',
        name: 'x-wechat-key',
      ...
      {
        label: '微信 Pass Ticket',
        name: 'x-wechat-pass-ticket',
        location: 'header',
        required: true,
        default: 'N/A',
        type: 'String',
        remark: '从文章链接查询参数导入的短期 Credential',
      },
      {
        label: '起始索引',
        name: 'begin',
